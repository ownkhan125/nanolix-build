...
const viewports = [
  { name: "scope-1440", width: 1440, height: 900 },
  { name: "scope-768", width: 768, height: 1024 },
  { name: "scope-375", width: 375, height: 812 },
];
...
(async () => {
  ...
  try {
    for (const v of viewports) {
      ...
      const sec = await page.$("#scope");
      if (!sec) {
        console.log(`${v.name}: #scope not found`);
        continue;
      }
